...
This repository contains configuration for running a Base node locally.

### Prerequisites
- Docker
- Docker Compose
- Access to an L1 RPC endpoint

### Running the node

1. Configure environment variables (see `.env` or existing env files).
